...
import Web3 from 'web3'; // Импорт библиотеки Web3
...
const callSmartContract = async () => {
	try {
		// Инициализация Web3 с выбранным провайдером
		const web3 = new Web3(window.ethereum);

		// Получить экземпляр смарт-контракта по его адресу и ABI
		const contractInstance = new web3.eth.Contract(abi, '0x694E31fB6cf8E86Bb09e67D58b82B5abc6C2065E');

		// Выполнить вызов функции смарт-контракта (замените 'functionName' на имя нужной функции)
		const result = await contractInstance.methods.functionName().call();

		// Обработать результат вызова функции
